...
public interface UserService {
    ...
    void registration(String login, byte[] password, String name, String surname, String email, String phone, String address, Date birthDate, int roleId) throws ServiceException;
}
